...
BIBS = SimpleNamespace(
    ...
    HIP_B="1997HIP...C......0E",
    GCPD_N="Hauck, B.; et al., 1990, General Catalogue of Photometric Data",  # useful for reference V mag in bright stars, better than Hipparcos
    GCPD_B="1995yCat.2167....0H",
    WDS_N="Mason, B. D.; et al., 2014, VizieR Online Data Catalog: The Washington Visual Double Star Catalog",
    WDS_B="2025yCat....102026M",
    ...
    CRTS_N="Drake, A. J.; et al., 2009, Catalina Real-time Transient Survey",
    CRTS_B="2009ApJ...696..870D",
    SWASP_N="Butters, O. W.; et al., 2010, The first WASP public data release",  # SuperWASP
    SWASP_B="2010A&A...520L..10B",
